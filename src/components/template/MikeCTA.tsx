        ...
        <div className="container max-w-7xl mx-auto px-16 py-28">
          <div className="flex flex-col-reverse xl:flex-row">
            <div className="xl:w-2/3 text-center xl:text-justify">
              <h3 className="text-2xl text-gray-200 text-third lg:text-4xl font-bold mb-3 xl:mb-6">Book a mixing session today!</h3>
              <p className="text-third text-gray-200 text-base lg:text-xl mb-4">We'd love to bring you mix to the next level! Book a session today and let us know what kind of session you would like us to do. We'll get back within 24 hours!</p>
              <Button>
