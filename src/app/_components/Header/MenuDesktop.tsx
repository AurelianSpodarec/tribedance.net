...
function MenuDesktop() {
  return (
    <nav className="hidden lg:flex container align-center justify-between flex-wrap p-5 flex-col md:flex-row items-center h-[75px]">
      ...
      <div className="hidden lg:flex ml-auto text-white flex gap-3">
