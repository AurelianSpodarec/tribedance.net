...
function NavItem({ name, url, isActive }: IMenuItem) {
  return (
    <Link className="uppercase font-bold text-white" href={url}>{name}</Link>
  )
}

function MenuDesktop() {
  return (
    <nav className="hidden xl:flex container align-center justify-between flex-wrap p-5 flex-col md:flex-row items-center h-[75px]">
      <Link href="/" className="mr-8">
        <img className="max-w-[150px]" src="/images/logo.png" />
      ...
      <div className="hidden xl:flex ml-auto text-white flex gap-3">
        ...
        <a className="w-4 h-4" href="https://web.archive.org/web/20210804102115/https://www.instagram.com/realmikemcfly" target="_blank">
