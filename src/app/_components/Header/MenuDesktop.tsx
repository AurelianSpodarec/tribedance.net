...
function MenuDesktop() {
  return (
    <nav className="hidden xl:flex container align-center justify-between flex-wrap p-5 flex-col md:flex-row items-center h-[75px]">
      ...
      <div className="hidden xl:flex ml-auto text-white flex gap-4">
        <Link className="w-6 h-6" href="https://soundcloud.com/realmikemcfly" target="_blank">
        ...
        <Link className="w-4 h-4" href="https://www.facebook.com/itsfakemcfly" target="_blank">
        ...
        <Link className="w-4 h-4" href="https://www.instagram.com/realmikemcfly" target="_blank">
